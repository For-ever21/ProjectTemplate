 ...
 * @LastEditors    : Qiao
 * @LastEditTime   : 2021-04-06 10:22:48
 * @FilePath       : /src/modules/error-pages/404.vue
 * @Description    : 错误页面
-->
<template>
  <div class="error-page">
    ...
    <div class="notFound">
      <span class="not_1">OOPS!</span>
      <span class="not_2">啊哦~~~你访问的页面不存在哦</span>
      <span class="not_3">请检查您输入的网址是否正确，请点击以下按钮返回主页</span>
      <span class="not_4">
...
<style lang="less" scoped>
    ...
    .notFound {
      ...
      span {
        ...
        &.not_1 {
          ...
          opacity: 0;
          margin-bottom: 20px;
          animation-name: slideUp-data-v-9b3484c8;
  ...
  .pic-404__child.left {
    ...
    left: 200px;
    opacity: 0;
    animation-name: cloudLeft-data-v-9b3484c8;
  ...
  .pic-404__child.mid {
    ...
    left: 350px;
    opacity: 0;
    animation-name: cloudMid-data-v-9b3484c8;
    animation-duration: 2s;
    animation-timing-function: linear;
    animation-fill-mode: forwards;
  ...
  .pic-404__child.right {
    ...
    left: 430px;
    opacity: 0;
    animation-name: cloudRight-data-v-9b3484c8;
    animation-duration: 2s;
    animation-timing-function: linear;
    animation-fill-mode: forwards;
    animation-delay: 1s;
  }
  @keyframes slideUp-data-v-9b3484c8 {
    0% {
  ...
  @keyframes cloudRight-data-v-9b3484c8 {
    0% {
      top: 100px;
      left: 430px;
      opacity: 0;
  ...
  @keyframes cloudMid-data-v-9b3484c8 {
    0% {
      top: 10px;
      left: 350px;
      opacity: 0;
  ...
  @keyframes cloudLeft-data-v-9b3484c8 {
    0% {
      top: 17px;
      left: 220px;
      opacity: 0;
